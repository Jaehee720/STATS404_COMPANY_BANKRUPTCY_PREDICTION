...
if __name__ == '__main__':
    ...
    important_features = ['net income to total assets', 'Cash flow to total assets', 'tax Pre-net interest rate', 'inventory and accounts receivable/net value']

    # Save y feature and all important X features
    new_df = pd.concat([df['Bankrupt?'], df[important_features], X[selected_columns]], axis=1)
